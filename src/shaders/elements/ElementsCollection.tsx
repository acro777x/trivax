...
const KAVIROX_LOGO_PATH = "M50 6 a44 44 0 1 1 -0.001 0 z M50 14 a36 36 0 1 0 0.001 0 z M22 38 L8 50 L22 62 L26 58 L16 50 L26 42 Z M78 38 L92 50 L78 62 L74 58 L84 50 L74 42 Z M46 30 L46 70 L54 70 L54 56 L62 70 L72 70 L60 51 L72 30 L62 30 L54 45 L54 30 Z M14 22 h6 v6 h-6 z M22 14 h6 v6 h-6 z M30 22 h6 v6 h-6 z M22 30 h6 v6 h-6 z M14 30 h6 v6 h-6 z M30 14 h6 v6 h-6 z";
...
(function () {
  ...
  return applyDetailPatches(elementalMarksSource)
    ...
    .replace(
      ...
      `Object.defineProperty(LOGO_PATHS, 'openai', { configurable: true, get() { return ${JSON.stringify(KAVIROX_LOGO_PATH)}; } });\n  openai: buildLogo(LOGO_PATHS.openai),`,
    )
    .replace(
